...
module.exports = function (grunt) { // jshint ignore:line
  ...
  // The default task (running 'grunt' in console) заменим на полный фарш
  grunt.registerTask('default', ['jshint', 'csslint', 'bootlint', 'concat', 'uglify', 'less:development', 'less:production', 'replace']);
};
